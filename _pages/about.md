...
/* 2. 按钮栏 */
.paper-buttons{margin-top:8px;margin-bottom:10px;display:flex;gap:10px;flex-wrap:wrap;align-items:center}.paper-btn{display:inline-block;padding:5px 12px;font-size:13px;font-weight:600;color:#444;background-color:#f1f3f5;border:1px solid #d1d5da;border-radius:4px;cursor:pointer;text-decoration:none!important;transition:all .2s ease;line-height:1.5;user-select:none}.paper-btn:hover{background-color:#e9ecef;transform:translateY(-1px);box-shadow:0 2px 5px rgba(0,0,0,0.05)}.btn-video{color:#fff!important;background-color:#d9534f;border-color:#d43f3a}.btn-video:hover{background-color:#c9302c;color:#fff!important}

/* 3. 弹窗逻辑 */
details>summary{list-style:none}details>summary::-webkit-details-marker{display:none}
/* 透明背景层 */
details[open]>summary::before{content:"";position:fixed;top:0;left:0;width:100vw;height:100vh;background:rgba(0,0,0,0.01);z-index:999;cursor:default}
/* 打开后冻结 Summary 按钮防止抖动，但允许背景点击穿透 */
details[open]>summary{pointer-events:none}

/* 内容卡片 */
details[open]>.paper-content{position:fixed;top:50%;left:50%;transform:translate(-50%,-50%);z-index:1000;width:90%;max-width:800px;max-height:85vh;overflow-y:auto;background-color:#fff;padding:25px;border-radius:8px;box-shadow:0 5px 40px rgba(0,0,0,.2);border:1px solid #ddd;animation:modalPop .2s ease-out;pointer-events:auto}
@keyframes modalPop{from{opacity:0;transform:translate(-50%,-48%) scale(.95)}to{opacity:1;transform:translate(-50%,-50%) scale(1)}}

/* 关闭按钮 */
.modal-close{position:absolute;top:10px;right:15px;font-size:24px;color:#aaa;cursor:pointer;z-index:1005;pointer-events:auto}.modal-close:hover{color:#333}

/* 4. BibTeX 格式化 (关键：pre保留换行) */
...
<script>
!function(){document.addEventListener("click",function(e){var t=e.target;if(t&&t.classList.contains("copy-btn")){if("Copied!"===t.innerText)return;var n=t.closest(".bibtex-container");if(n){var o=n.querySelector(".bibtex-code");if(o){var c=document.createElement("textarea");c.value=o.innerText,c.style.position="fixed",c.style.left="-9999px",document.body.appendChild(c),c.select();try{document.execCommand("copy");var i=t.innerText;t.innerText="Copied!",t.style.color="#28a745",t.style.borderColor="#28a745",setTimeout(function(){t.innerText=i,t.style.color="",t.style.borderColor=""},2e3)}catch(e){console.error(e)}document.body.removeChild(c)}}}var r=t.closest("details");r&&r.hasAttribute("open")&&!t.closest(".paper-content")&&!t.closest("summary")&&r.removeAttribute("open")})}();
</script>
